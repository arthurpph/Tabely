...
function QueueOffCanvas(props: QueueOffCanvasProps) {
    const { showQueue, handleClose, queue, customQueue, setMusic, changeQueue, currentPlaylist } = props;
        ...
        <Offcanvas show={showQueue} onHide={handleClose} placement="end" className="offcanvas">
            ...
            <Offcanvas.Body>
                <div className="queue-container">
                    ...
                    {queue.length > 0 ? queue.map((music, index) => (
                        <div key={index}>
                            {index + 1}
